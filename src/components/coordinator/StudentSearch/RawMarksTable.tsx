...
// clientside/src/components/coordinator/StudentSearch/RawMarksTable.tsx
"use client";
    ...
    <div className="bg-green-dark/5 rounded-lg p-6 border border-green-dark/10">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-xs text-green-dark/70 uppercase">
            Year {isReadOnly ? "Historical" : "Active"} Breakdown
          </p>
        </div>
      ...
      {marks.length === 0 ? (
        <div className="py-20 text-center">
          <p className="text-xl text-green-darkest/40 font-medium italic">
            No raw marks uploaded for this academic cycle.
          </p>
        </div>
      ) : (
        <div className="overflow-x-auto rounded-lg border border-green-dark/20">
            ...
            <tbody className="bg-white">
              {marks.map((m) => {
                ...
                return (
                  <tr
                    key={m._id}
                    className="border-t border-green-dark/10 hover:bg-green-50 transition-colors font-mono text-xs text-green-darkest"
                  >
                    <td className="p-4 font-sans">{m.academicYear.year}</td>
                    <td className="p-4 font-bold">{unitCode}</td>
                    ...
                    <td className="p-4 text-center font-black bg-green-50/50">
                      {m.agreedMark ?? 0}
                    </td>
                    <td className="p-4 text-center text-[10px]">
                      <span
