      ...
      <div className="rounded-lg shadow-md bg-white mb-4">
        <div className="flex">
          <input
            ...
            className="flex-1 px-4 py-2 text-xs font-mono text-green-darkest/50 border-0 border-r-transparent border-green-transparent rounded-br-none rounded-tr-none rounded-lg placeholder-slate-300/50 outline-0 focus:outline-0 "
          />
