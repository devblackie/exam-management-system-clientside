...
const LogoSection = () => (
  <div className="p-6 flex flex-col items-center justify-center gap-2 ">
    ...
    <div className="text-center mt-2 px-2 w-full">
      <p className="text-[9px] font-bold uppercase tracking-wider text-yellow-gold/80 leading-relaxed whitespace-normal break-words max-w-[140px] mx-auto">
        {universityName}
      </p>
      <div className="w-8 h-px bg-yellow-gold/30 mx-auto mt-2" />
    </div>
  </div>
);
...
const MobileLogoSection = () => (
  <div className="flex flex-col items-center justify-center gap-2 mb-8">
    ...
    <div className="text-center">
      <p className="text-[10px] font-bold uppercase tracking-wider text-yellow-gold/80 leading-tight break-words">
        {universityName}
      </p>
      <div className="w-12 h-px bg-yellow-gold/30 mx-auto mt-1.5" />
    </div>
  </div>
);
