            ...
            >
              ...
              {result.errors.length > 0 && (
                <div className="border-t border-slate-100 p-8 bg-slate-50/50">
                  <summary className="cursor-pointer text-[10px] font-black text-red-500 tracking-[0.3em] mb-4 hover:underline">
                    Conflict Resolution Log ({result.errors.length} error(s))
                  </summary>
                  <div className="space-y-2">
