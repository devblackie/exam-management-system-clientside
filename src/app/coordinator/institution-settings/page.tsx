      ...
      <div className="bg-[#F8F9FA] rounded-lg shadow-2xl p-10 min-h-screen">
        ...
        <div className="grid grid-cols-12 gap-8">
            ...
            <section className="bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-100 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="mt-8 flex items-center gap-4 p-6 bg-amber-50/50 rounded-2xl border border-amber-100">
          ...
          <div className="col-span-12 lg:col-span-4">
            <section className="bg-slate-900 rounded-[2.5rem] p-10 shadow-2xl sticky top-8 text-white">
              <div className="flex items-center gap-4 mb-10">
                ...
                {settings.gradingScale?.map((row, i) => (
                  ...
                  >
                    <div className="flex-1">
                      <span className="text-[9px] font-black uppercase text-white/40 block mb-1">
                        Min Score
                      </span>
                      <input
                        type="number"
                    ...
                    <div className="w-16 text-center border-l border-white/10 pl-4">
                      ...
                      <input
                        ...
                        className="bg-transparent text-xl font-black text-emerald-400 outline-none w-full text-center"
                      />
                    </div>
                  </div>
                ))}
              ...
              <div className="mt-10 p-6 bg-emerald-500 rounded-[1.5rem] flex items-center justify-between group cursor-pointer">
                <div>
...
function MinimalInput({ label, value, onChange,}: {
  ...
  return (
    <div className="w-full">
      <label className="text-[10px] font-black uppercase tracking-tighter text-slate-400 mb-2 block">
        {label}
      </label>
      <input
        type="number"
        ...
        className="w-full bg-slate-50 border-none rounded-xl px-4 py-3 text-slate-900 font-bold focus:ring-2 focus:ring-emerald-500/20 transition-all outline-none"
      />
    </div>
  );
}
