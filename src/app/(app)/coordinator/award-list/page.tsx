...
// import {GraduationCap,  Spotlight, Loader2, Trophy, Users, ChevronDown, ChevronRight, Filter, Fingerprint, ShieldAlert, FileSpreadsheet } from "lucide-react";
...
export default function AwardListPage() {
  ...
  const [downloading, setDownloading] = useState<
    "simple" | "classified" | "journey" | null
  >(null);
  const [journeyProgress, setJourneyProgress] = useState<number | null>(null);
              ...
              >
                {downloading === "journey" ? (
                  <>
                    <Loader2 size={18} className="animate-spin" />
                    Journey CMS{" "}
                    {journeyProgress !== null ? `${journeyProgress}%` : ""}
                  </>
                ) : (
                  <>
                    <FileSpreadsheet
