...
import {
  Users, Mail, ShieldCheck, Activity, ArrowUpRight, Settings, UserCheck,
  UserX, CheckCircle2, XCircle, BookOpen, GraduationCap, Gauge, Wallet, Building2,
} from "lucide-react";
import PageHeader from "@/components/ui/PageHeader";
...
export default function AdminDashboard() {
  ...
  // Get pass mark and exam weight from ruleSet
                    ...
                    <div className="flex flex-wrap gap-2">
                      {[...settings.gradingScale]
                        ...
                        .map(g => (
                          ...
                          >
                            <span className="text-[13px] font-black text-green-darkest">{g.grade}</span>
                            <span className="text-[11px] text-slate-400">{g.min}–{g.max}%</span>
                            <span className="text-[10px] text-yellow-gold font-bold">{g.label}</span>
                          </div>
                        ))}
                    </div>
                  </div>
